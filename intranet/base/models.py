...
class People(index.Indexed, ClusterableModel):
    ...
    job_title = models.CharField("Job title", max_length=254, help_text="Select the person's job title")
    center = 'CD'
    academic = 'AD'
    operation = 'OD'
    division_choices = [
    ...
    division = models.CharField(
        ...
        default=center,
        help_text="Select the person's division"
    )
...
class HomePage(Page):
    ...
    hero_text = models.CharField(
        max_length=255,
        help_text='Write an introduction for this site',
        null=True,
        blank=True
    )
